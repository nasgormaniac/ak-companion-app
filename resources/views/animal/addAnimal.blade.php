...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-xl p-4 bg-white shadow-lg rounded-2xl">
        <form class="w-full max-w-lg" enctype="multipart/form-data" action="{{ route('animal.store') }}" method="POST" autocomplete="off">
            @csrf
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative">
                        <select
                            ...
                            <option value="G" selected>Guts</option>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="animal-code" type="text" placeholder="Barcode" name="card_code" required>
                </div>
