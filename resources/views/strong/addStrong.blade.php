...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-xl p-4 bg-white shadow rounded-2xl">
        <form class="w-full max-w-lg" enctype="multipart/form-data" action="{{ route('strong.store') }}" method="POST" autocomplete="off">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="animal-name" type="text" name="nama" placeholder="Card name" required>
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="animal-code" type="text" name="card_code" placeholder="Barcode" required>
                </div>
